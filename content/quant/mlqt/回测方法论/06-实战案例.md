...
![完整量化回测流水线](../../image/01-framework-backtest-pipeline.png)
...
![Top-K 等权 vs IC 加权组合构建对比](../../image/02-comparison-portfolio-methods.png)
...
![回测引擎执行流程](../../image/03-flowchart-execution-engine.png)
...
![回测绩效评估仪表盘](../../image/04-infographic-performance-dashboard.png)
