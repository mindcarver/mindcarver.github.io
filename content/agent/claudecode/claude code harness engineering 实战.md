...
这说明 Anthropic 对 planner 的定位不是"架构师一次定终局"，更像是"给出方向和验收空间"。
...
![Harness Engineering 三层职责分离架构](../../image/harness-engineering/01-framework-harness-architecture.png)
...
![Sprint Contract 机制 — 从模糊意图到可验证目标](../../image/harness-engineering/02-flowchart-sprint-contract.png)
...
![Harness Engineering 成本与收益](../../image/harness-engineering/03-infographic-cost-benefit.png)
...
![Anthropic vs OpenAI Harness 设计哲学对比](../../image/harness-engineering/04-comparison-harness-philosophy.png)
